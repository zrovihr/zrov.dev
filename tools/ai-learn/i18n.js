...
(function () {
  ...
  var mappings = [
    ...
    { selector: '#level-3 .level-img-secondary', attr: 'alt', en: 'Screenshot of the Codex desktop app — chatting with AI about project code' },
    ...
    { selector: '#level-3 .steps .section-label:nth-of-type(3)', en: 'Extra steps — if you code:' },
    { selector: '#level-3 .steps ol:nth-of-type(3)', en: '<li>Install <a href="https://code.visualstudio.com" target="_blank" rel="noopener">VS Code</a> — a free code editor from Microsoft, and an industry standard</li><li>Add <strong>Claude for VS Code</strong> (Anthropic official extension) — Claude can read the file you have open, suggest changes, and edit directly. See the screenshot above: Claude in the right sidebar, file in the middle, terminal at the bottom</li><li>Also try <strong>Codex</strong> — OpenAI desktop app for coding. Install it from <a href="https://openai.com/codex" target="_blank" rel="noopener">openai.com/codex</a>. Unlike normal ChatGPT, Codex understands your project context and can read/edit multiple files at once</li><li>Free alternatives: <strong>GitHub Copilot</strong> (free for students/open source) or <strong>Cline</strong> (open-source VS Code extension). Pick one, do not install everything</li>' },
    { selector: '#level-3 .img-caption', en: 'Codex desktop app — interface built for coding, can read the whole project' },
